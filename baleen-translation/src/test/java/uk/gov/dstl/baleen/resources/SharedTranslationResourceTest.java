...
public class SharedTranslationResourceTest {
  ...
  public void canCreateWithService() throws ResourceInitializationException, TranslationException {
    ExternalResourceDescription erd = ExternalResourceFactory.createExternalResourceDescription(
        SharedTranslationResource.RESOURCE_KEY, SharedTranslationResource.class,
        SharedTranslationResource.PARAM_SERVICE, TestTranslateService.class.getSimpleName());
  ...
  public void canCreateWithConfiguredService()
    ...
    ExternalResourceDescription erd = ExternalResourceFactory.createExternalResourceDescription(
        ...
        SharedTranslationResource.PARAM_CONFIG, config);
