...
public class StructuralHtmlTest {
  ...
  public void testTags() throws Exception {
    ...
    // The documnet generated here is obviously nonsense from all perspectives but can visually
    // inspect the
    // output is as expected

    // NOTE: This doesnt' include table sub elements as they need valid nesting
    final Class<?>[] classes =
