...
public class MongoRecordConsumerTest extends AbstractRecordConsumerTest {
	...
	public MongoRecordConsumerTest() {
		super(MongoRecordConsumer.class);
	}
	...
	public void testRecords()
		...
		assertEquals("MongoRecordConsumer.txt", mongoRecords.getSourceUri());
