...
public class TikaContentExtractorTest {
  ...
  public void testTikaWord() throws Exception {
    ...
    final File f = new File(getClass().getResource("test.docx").getPath());
    ...
    final Collection<Metadata> metadata = JCasUtil.select(jCas, Metadata.class);
  ...
  public void testTikaText() throws Exception {
    ...
    final File f = new File(getClass().getResource("test.txt").getPath());
  ...
  public void testTikaWrappingDocx() throws Exception {
    ...
    final File f = new File(getClass().getResource("wrappingLines.docx").getPath());
  ...
  public void testTikaCorruptFile() throws Exception {
    ...
    final File f = new File(getClass().getResource("corrupt.docx").getPath());
