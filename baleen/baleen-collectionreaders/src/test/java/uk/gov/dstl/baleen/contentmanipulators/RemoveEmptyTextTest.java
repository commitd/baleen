...
public class RemoveEmptyTextTest {
  ...
  public void testNonEmpty() {
    ...
    final Document doc = Jsoup.parseBodyFragment("<p>Hello</p>");
    m.manipulate(doc);
  ...
  public void testSingleEmpty() {
    ...
    final Document doc = Jsoup.parseBodyFragment("<p></p>");
    m.manipulate(doc);
  ...
  public void testTwoEmpty() {
    ...
    final Document doc = Jsoup.parseBodyFragment("<p></p><div></div>");
    m.manipulate(doc);
  ...
  public void testMixedEmpty() {
    ...
    final Document doc = Jsoup.parseBodyFragment("<p></p><div></div><p>Hello</p>");
    m.manipulate(doc);
  ...
  public void testHierarchyOfEmpty() {
    ...
    final Document doc = Jsoup.parseBodyFragment("<div><p></p></div>");
    m.manipulate(doc);
