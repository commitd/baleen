...
public class NewLineToNewParagraphTest {
  ...
  public void testNoSplit() {
    final Document doc = Jsoup.parseBodyFragment("<p>This is some text</p>");
    m.manipulate(doc);
  ...
  public void testOneSplitInP() {
    final Document doc = Jsoup.parseBodyFragment("<p>This is <br /> some text</p>");
    m.manipulate(doc);
  ...
  public void testTwoSplitInP() {
    final Document doc = Jsoup.parseBodyFragment("<p>This <br /> is some<br /> text</p>");
    m.manipulate(doc);
  ...
  public void testSplitInLi() {
    final Document doc = Jsoup.parseBodyFragment("<li>This is  <br />some text</li>");
    m.manipulate(doc);
