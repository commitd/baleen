...
public class Jsp101Headings implements ContentManipulator {
  ...
  public void manipulate(final Document document) {
    ...
    // Descriptions taked from the JSP101 Chapter 6, Paragraph 23....
   ...
   */
  private void addHeading(final Document document, final boolean capitals,
  ...
  private boolean isAllUpperCase(final String text) {
    return text.toUpperCase().equals(text);
  }

  private boolean isBold(final Element e, final String text) {
    ...
    final Elements boldChildren = e.select("b");
